...
<body>
   ...
   <%
      ...
      String file = (String)addgoods.getGoodsFile1();
      session.setAttribute("file",file);
   %>
   <form action="updateServlet" enctype="multipart/form-data"
      method="post">
      <input type="hidden" name="id" value="<%=addgoods.getId()%>">
         <div id="main">
         ...
         <div id="top" class="toCenter">
            ...
            <input type="text" name="goodsName" value="<%=addgoods.getGoodsName()%>">
         </div>
         <div id="content">
            <div id="left">
            
               <div id= "holder"><img height="400" width="300" src="ImageFile/<%=addgoods.getGoodsFile1()%>" id="status"
                  class="success"></div>
               <div>
            ...
            <div id="right">
               <div id = "price">
                  가격&nbsp;&nbsp;<input type="text" name="goodsPrice" value="<%=addgoods.getGoodsPrice()%>">&nbsp;원
               </div>
               <div>
               <textarea name="goodsContents" id="textarea"><%=addgoods.getGoodsContents()%></textarea>
               </div>
            </div>
         </div>
